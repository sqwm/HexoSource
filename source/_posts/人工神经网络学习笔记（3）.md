...
<!-- more -->
<div align=center>
![Mnist | ](https://upload-images.jianshu.io/upload_images/8389494-c279133be28eb263.jpg)
</div>
...
* 初始花链接权重矩阵：使用正态概率分布采样权重，平均值为0，标准方差为结点传入链接数目的开方，即$\frac{1}{\sqrt{input_connect}}$
...
---
##### <font color=green> neural_network.py </font>
```python
import numpy
...
```
##### <font color=green> network_test.py </font>
```python
